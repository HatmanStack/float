...
Copy `.env.example` to `.env` and fill in your API keys (see [README.md](../README.md) for details).

## Performance Tips

- **Frontend**: Use React DevTools Profiler to check for unnecessary re-renders
- **Backend**: Profile slow tests with `pytest tests/ --durations=10`
...
**VS Code**: Install ESLint, Prettier, TypeScript, Python, and Ruff extensions. Enable
auto-format on save.
